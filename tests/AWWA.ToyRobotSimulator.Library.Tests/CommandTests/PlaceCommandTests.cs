...
namespace AWWA.ToyRobotSimulator.Library.Tests.CommandTests
{
	public class PlaceCommandTests
	{
        ...
        [Fact]
        public void Given_A_Blank_Board_When_A_PlaceCommand_Is_Issued_Without_A_Direction_Then_The_Command_Should_Fail()
        {
            //Arrange
            Board board = new Board(6, 6);
        ...
        [Fact]
		public void Given_A_Robot_Is_Already_On_The_Board_When_A_PlaceCommand_Is_Issued_Then_The_Command_Should_Validate()
		{
            //Arrange
